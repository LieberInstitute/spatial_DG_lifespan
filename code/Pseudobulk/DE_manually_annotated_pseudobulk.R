...
# DE analysis of pseudo-bulked Manual Annotations
...
save(f_stats, eb0_list, eb_contrasts,
    file = here::here("processed-data", "pseudobulk_spe", "manual_annotation_modeling_results.Rdata")
)
