...
pdf(file = here::here("plots", "pseudobulked", "infant_enrichment_heatmap.pdf"), width = 8, height = 8)
pheatmap(
    exprs_heatmap,
    cluster_rows = TRUE,
    cluster_cols = TRUE,
    ...
    fontsize_row = 9,
    main = "logcounts from enrichment model of Infants top 10 genes/cluster",
)
dev.off()
