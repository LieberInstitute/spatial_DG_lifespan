...
pdf(file = here::here("plots","pseudobulked","infant_enrichment_heatmap_all.pdf"), width = 8, height = 8)
pheatmap(
    exprs_heatmap,
    cluster_rows = FALSE,
    cluster_cols = FALSE,
    ...
    fontsize_row = 9,
    main = "logcounts for enrichment model of Infants top 10 genes/cluster",
)
dev.off()
