...
colnames(neurogen_heatmap) = paste("logcount", 1:64, sep = "")
...
pdf(file = here::here("plots","pseudobulked","neurogenesis_regulation_enrichment_heatmap_all.pdf"), width = 12, height = 12)
pheatmap(
    neurogen_heatmap,
    cluster_rows = TRUE,
    cluster_cols = TRUE,
    ...
    fontsize_row = 9,
    main = "logcounts for enrichment model with genes for neurogenesis regulation per cluster",
)
dev.off()
