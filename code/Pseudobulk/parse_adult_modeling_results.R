...
load(file = here::here("processed-data", "pseudobulk_spe", "adult_bayesspace_cluster_modeling_results.Rdata"))
...
saveRDS(modeling_results, file = here::here("processed-data", "pseudobulk_spe", "adult_modeling_results.rds"))
...
pdf(file = here::here("plots", "pseudobulked", "plot_adult_enrichment_DEGs.pdf"))
