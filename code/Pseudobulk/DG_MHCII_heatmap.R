...
colnames(MHCII_heatmap) <- paste("logcount", 1:64, sep = "")

# Plot heatmap of logcounts for clusters and samples
pdf(file = here::here("plots", "pseudobulked", "DG_antigen_MHC_class_II_enrichment_heatmap.pdf"),
    width = 7, height = 6)
...
Heatmap(MHCII_heatmap,
    ...
    col = list(spatial_domain = c("ML" = "#E4E1E3", "CA3&4" = "#FEAF16", "SGZ" = "#1CFFCE", "GCL" = "#B00068"),
...
pdf(file = here::here("plots", "pseudobulked", "zscores_DG_antigen_MHC_class_II_enrichment_heatmap.pdf"),
    width = 7, height = 6)
