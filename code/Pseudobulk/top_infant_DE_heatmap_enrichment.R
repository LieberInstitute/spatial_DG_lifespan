...
# Get top 10 up and down for each

combinedtop <- rbind(ML_up[1:10,], ML_down[1:10,], GCL_up[1:10,], GCL_down[1:10,],
    SGZ_up[1:10,], SGZ_down[1:10,], CA3_4_up[1:10,], CA3_4_down[1:10,])
...
pdf(file = here::here("plots", "pseudobulked", "Top_DE_infant_vs_noninfant.pdf"), height = 10)
...
Heatmap(top_genes_heatmap,
    ...
    col = col_fun,
    column_title = "Top enriched/depleted infant DE results in DG spatial domains",
...
# Plot heatmap of logcounts for clusters and samples
pdf(file = here::here("plots", "pseudobulked", "zscores_Top_DE_infant_vs_noninfant.pdf"), height = 10)
