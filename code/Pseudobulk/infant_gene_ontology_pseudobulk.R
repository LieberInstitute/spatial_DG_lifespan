...
modeling_results <- readRDS(file = here::here("processed-data", "pseudobulk_spe", "infant_modeling_results.rds"))
...
clust_compare <- list(
    clust_1$ENTREZID, clust_2$ENTREZID, GCL$ENTREZID, SGZ$ENTREZID,
...
save(clust_1_CC, clust_1_MF, clust_1_BP, clust_2_CC, clust_2_MF, clust_2_BP,
    ...
    file = here::here("processed-data", "pseudobulk_spe", "gene_ontologies", "infant_samples_enrichedGO.Rdata")
)
...
# For Cluster 1
pdf(file = here::here("plots", "pseudobulked", "infant_clust_1_GO.pdf"), width = 16, height = 10)

barplot(clust_1_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_1 Cellular Compartment")
barplot(clust_1_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_1 Molecular Function")
barplot(clust_1_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_1 Biological Process")

clust_1_CCx <- setReadable(clust_1_CC, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_1_CCx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_1 Cellular Compartment Network")
clust_1_MFx <- setReadable(clust_1_MF, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_1_MFx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_1 Molecular Function Network")
clust_1_BPx <- setReadable(clust_1_BP, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_1_BPx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_1 Biological Process Network")

clust_1_CCp <- pairwise_termsim(clust_1_CC)
emapplot(clust_1_CCp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_1 Cellular Compartment Modules")
clust_1_MFp <- pairwise_termsim(clust_1_MF)
emapplot(clust_1_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_1 Molecular Function Modules")
clust_1_BPp <- pairwise_termsim(clust_1_BP)
emapplot(clust_1_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_1 Biological Process Modules")

dev.off()

# For Cluster 2
pdf(file = here::here("plots", "pseudobulked", "infant_clust_2_GO.pdf"), width = 16, height = 10)

barplot(clust_2_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_2 Cellular Compartment")
barplot(clust_2_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_2 Molecular Function")
barplot(clust_2_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_2 Biological Process")

clust_2_CCx <- setReadable(clust_2_CC, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_2_CCx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_2 Cellular Compartment Network")
clust_2_MFx <- setReadable(clust_2_MF, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_2_MFx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_2 Molecular Function Network")
clust_2_BPx <- setReadable(clust_2_BP, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_2_BPx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_2 Biological Process Network")

clust_2_CCp <- pairwise_termsim(clust_2_CC)
emapplot(clust_2_CCp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_2 Cellular Compartment Modules")
clust_2_MFp <- pairwise_termsim(clust_2_MF)
emapplot(clust_2_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_2 Molecular Function Modules")
clust_2_BPp <- pairwise_termsim(clust_2_BP)
emapplot(clust_2_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_2 Biological Process Modules")

dev.off()

# For GCL

pdf(file = here::here("plots", "pseudobulked", "infant_GCL_GO.pdf"), width = 16, height = 10)

barplot(GCL_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_GCL Cellular Compartment")
barplot(GCL_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_GCL Molecular Function")
barplot(GCL_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_GCL Biological Process")
...
cnetplot(GCL_CCx,
    ...
    ggtitle("infant_GCL Cellular Compartment Network")
...
cnetplot(GCL_MFx,
    ...
    ggtitle("infant_GCL Molecular Function Network")
...
cnetplot(GCL_BPx,
    ...
    ggtitle("infant_GCL Biological Process Network")
...
emapplot(GCL_CCp,
    ...
    ggtitle("infant_GCL Cellular Compartment Modules")
GCL_MFp <- pairwise_termsim(GCL_MF)
emapplot(GCL_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_GCL Molecular Function Modules")
GCL_BPp <- pairwise_termsim(GCL_BP)
emapplot(GCL_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_GCL Biological Process Modules")

dev.off()

# For SGZ

pdf(file = here::here("plots", "pseudobulked", "infant_SGZ_GO.pdf"), width = 16, height = 10)

barplot(SGZ_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_SGZ Cellular Compartment")
barplot(SGZ_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_SGZ Molecular Function")
barplot(SGZ_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_SGZ Biological Process")
...
cnetplot(SGZ_CCx,
    ...
    ggtitle("infant_SGZ Cellular Compartment Network")
...
cnetplot(SGZ_MFx,
    ...
    ggtitle("infant_SGZ Molecular Function Network")
...
cnetplot(SGZ_BPx,
    ...
    ggtitle("infant_SGZ Biological Process Network")
...
emapplot(SGZ_CCp,
    ...
    ggtitle("infant_SGZ Cellular Compartment Modules")
SGZ_MFp <- pairwise_termsim(SGZ_MF)
emapplot(SGZ_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_SGZ Molecular Function Modules")
SGZ_BPp <- pairwise_termsim(SGZ_BP)
emapplot(SGZ_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_SGZ Biological Process Modules")

dev.off()

# For CA4

pdf(file = here::here("plots", "pseudobulked", "infant_CA4_GO.pdf"), width = 16, height = 10)

barplot(CA4_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA4 Cellular Compartment")
barplot(CA4_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA4 Molecular Function")
barplot(CA4_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA4 Biological Process")
...
cnetplot(CA4_CCx,
    ...
    ggtitle("infant_CA4 Cellular Compartment Network")
...
cnetplot(CA4_MFx,
    ...
    ggtitle("infant_CA4 Molecular Function Network")
...
cnetplot(CA4_BPx,
    ...
    ggtitle("infant_CA4 Biological Process Network")
...
emapplot(CA4_CCp,
    ...
    ggtitle("infant_CA4 Cellular Compartment Modules")
CA4_MFp <- pairwise_termsim(CA4_MF)
emapplot(CA4_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_CA4 Molecular Function Modules")
CA4_BPp <- pairwise_termsim(CA4_BP)
emapplot(CA4_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_CA4 Biological Process Modules")

dev.off()

# For CA3

pdf(file = here::here("plots", "pseudobulked", "infant_CA3_GO.pdf"), width = 16, height = 10)

barplot(CA3_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA3 Cellular Compartment")
barplot(CA3_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA3 Molecular Function")
barplot(CA3_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_CA3 Biological Process")
...
cnetplot(CA3_CCx,
    ...
    ggtitle("infant_CA3 Cellular Compartment Network")
...
cnetplot(CA3_MFx,
    ...
    ggtitle("infant_CA3 Molecular Function Network")
...
cnetplot(CA3_BPx,
    ...
    ggtitle("infant_CA3 Biological Process Network")
...
emapplot(CA3_CCp,
    ...
    ggtitle("infant_CA3 Cellular Compartment Modules")
CA3_MFp <- pairwise_termsim(CA3_MF)
emapplot(CA3_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_CA3 Molecular Function Modules")
CA3_BPp <- pairwise_termsim(CA3_BP)
emapplot(CA3_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_CA3 Biological Process Modules")

dev.off()

# For Molecular Layer

pdf(file = here::here("plots", "pseudobulked", "infant_ML_GO.pdf"), width = 16, height = 10)

barplot(ML_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_ML Cellular Compartment")
barplot(ML_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_ML Molecular Function")
barplot(ML_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_ML Biological Process")
...
cnetplot(ML_CCx,
    ...
    ggtitle("infant_ML Cellular Compartment Network")
...
cnetplot(ML_MFx,
    ...
    ggtitle("infant_ML Molecular Function Network")
...
cnetplot(ML_BPx,
    ...
    ggtitle("infant_ML Biological Process Network")
...
emapplot(ML_CCp,
    ...
    ggtitle("infant_ML Cellular Compartment Modules")
ML_MFp <- pairwise_termsim(ML_MF)
emapplot(ML_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_ML Molecular Function Modules")
ML_BPp <- pairwise_termsim(ML_BP)
emapplot(ML_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_ML Biological Process Modules")

dev.off()

# For Cluster 8

pdf(file = here::here("plots", "pseudobulked", "infant_clust_8_GO.pdf"), width = 16, height = 10)

barplot(clust_8_CC, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_8 Cellular Compartment")
barplot(clust_8_MF, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_8 Molecular Function")
barplot(clust_8_BP, showCategory = 20, x = "GeneRatio") +
    ggtitle("infant_cluster_8 Biological Process")

clust_8_CCx <- setReadable(clust_8_CC, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_8_CCx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_8 Cellular Compartment Network")
clust_8_MFx <- setReadable(clust_8_MF, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_8_MFx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_8 Molecular Function Network")
clust_8_BPx <- setReadable(clust_8_BP, "org.Hs.eg.db", "ENTREZID")
cnetplot(clust_8_BPx,
    showCategory = 20, colorEdge = TRUE, cex_category = 0.2,
    cex_gene = 0.1, cex_label_category = 0.4, cex_label_gene = 0.2,
    shadow_text = "category", layout = "kk"
) +
    ggtitle("infant_cluster_8 Biological Process Network")

clust_8_CCp <- pairwise_termsim(clust_8_CC)
emapplot(clust_8_CCp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_8 Cellular Compartment Modules")
clust_8_MFp <- pairwise_termsim(clust_8_MF)
emapplot(clust_8_MFp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_8 Molecular Function Modules")
clust_8_BPp <- pairwise_termsim(clust_8_BP)
emapplot(clust_8_BPp,
    showCategory = 20, color = "p.adjust",
    cex_label_category = 0.5, layout = "kk"
) +
    ggtitle("infant_cluster_8 Biological Process Modules")

dev.off()

# For comparing clusters

pdf(file = here::here("plots", "pseudobulked", "infant_comparative_GO.pdf"), width = 20, height = 20)

dotplot(comp_CC, showCategory = 10) +
    theme(axis.text.y = element_text(size = 9)) +
    ggtitle("infant_Comparative GO Cellular Compartment")
dotplot(comp_MF, showCategory = 10) +
    theme(axis.text.y = element_text(size = 9)) +
    ggtitle("infant_Comparative GO Molecular Function")
dotplot(comp_BP, showCategory = 10) +
    theme(axis.text.y = element_text(size = 9)) +
    ggtitle("infant_Comparative GO Biological Process")

comp_CC <- pairwise_termsim(comp_CC)
emapplot(comp_CC,
    showCategory = 20, color = "p.adjust",
    pie = "count", cex_category = 5, layout = "kk"
) +
    ggtitle("infant_Comparative GO Cellular Compartment Modules")
comp_MF <- pairwise_termsim(comp_MF)
emapplot(comp_MF,
    showCategory = 20, color = "p.adjust",
    pie = "count", cex_category = 5, layout = "kk"
) +
    ggtitle("infant_Comparative GO Molecular Function Modules")
comp_BP <- pairwise_termsim(comp_BP)
emapplot(comp_BP,
    showCategory = 20, color = "p.adjust",
    pie = "count", cex_category = 5, layout = "kk"
) +
    ggtitle("infant_Comparative GO Biological Process Modules")
