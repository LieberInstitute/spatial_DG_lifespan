...
Heatmap(Hochgerner_heatmap,
    ...
    left_annotation = rowAnnotation(cell_marker = Hochgerner_2018_all$label,
        col = list(cell_marker = c("nIPC" = "lightblue", "NB1" = "dodgerblue", "NB2" = "midnightblue"))),
    right_annotation = rowAnnotation(foo = anno_mark(at = c(1, 30, 48, 49, 63, 70, 76, 80, 81, 89, 90, 92, 108, 146, 149, 150, 171, 172),
        labels = c("ASCL1", "NEUROG2", "SOX1", "SOX2", "CALB2", "ELAVL2", "IGFBPL1", "NEUROD1", "NEUROD6",
            "SOX11", "SOX5", "STMN1", "BHLHE22", "NEUROD2", "NPAS4", "NTF3", "STMN2", "STMN4"))),
    column_title = "Hochgerner et al., 2018 Gene markers for nIPCs & NBs",
    column_order = Bayes_age_order,
    show_column_names = FALSE,
    column_split = spe_pseudo$BayesSpace,
    row_split = Hochgerner_2018_all$label,
