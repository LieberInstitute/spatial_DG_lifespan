...
spe_cells <- as.data.frame(colData(spe)[, c(44:70)])
...
infant_cells <- as.data.frame(colData(infant_spe)[, c(44:70)])
...
teen_cells <- as.data.frame(colData(teen_spe)[, c(44:70)])
...
adult_cells <- as.data.frame(colData(adult_spe)[, c(44:70)])
...
elderly_cells <- as.data.frame(colData(elderly_spe)[, c(44:70)])
