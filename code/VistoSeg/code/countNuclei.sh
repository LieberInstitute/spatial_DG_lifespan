...
#$ -pe local 8
#$ -N spatial_hpc
#$ -o /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/logs/$TASK_ID_countNuclei.txt
#$ -e /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/logs/$TASK_ID_countNuclei.txt
#$ -m e
...
echo "****"
echo "Sample id: $(cat /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/countNuclei_list.txt | awk '{print $NF}' | awk "NR==${SGE_TASK_ID}")"
echo "****"
