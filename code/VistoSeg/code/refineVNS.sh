...
#$ -o /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/logs/$TASK_ID_refineVNS.txt 
#$ -e /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/logs/$TASK_ID_refineVNS.txt
#$ -m e
...
echo "****"
echo "Sample id: $(cat /dcs04/lieber/marmaypag/lifespanDG_LIBD001/spatial_DG_lifespan/code/VistoSeg/code/refineVNS_list.txt | awk '{print $NF}' | awk "NR==${SGE_TASK_ID}")"
echo "****"
